...
tle','dashboard')
@section('content')
<div class="content-wrapper" style="min-height: 449.667px;">
                            ...
                            <div class="tab-content p-0">
                                ...
                                <div class="chart tab-pane active" id="revenue-chart"
                                    ...
                                    <canvas id="revenue-chart-canvas" height="450"
                                        style="height: 300px; display: block; width: 800px;" width="1200"
                    ...
                    <div class="card bg-gradient-primary">
                        ...
                        <div class="card-body">
                            <div id="world-map"
                                ...
                                <svg width="800.333" height="250">
                                    <g transform="scale(0.42158516020236086) translate(469.69493800000004, 0)">
                                        <path
                    ...
                    <div class="card bg-gradient-info">
                        ...
                        <div class="card-body">
                            ...
                            <canvas class="chart chartjs-render-monitor" id="line-chart"
                                style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 800px;"
                                width="1200" height="375"></canvas>
                        </div>

                        <div class="card-footer bg-transparent">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <div style="display:inline;width:60px;height:60px;"><canvas width="90" height="90"
